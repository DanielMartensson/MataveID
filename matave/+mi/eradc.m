...
% Example 1: [sysd, K] = mi.eradc(g, sampleTime);
% Example 2: [sysd, K] = mi.eradc(g, sampleTime, ktune);
% Example 3: [sysd, K] = mi.eradc(g, sampleTime, ktune, delay);
% Example 4: [sysd, K] = mi.eradc(g, sampleTime, ktune, delay, systemorder);
