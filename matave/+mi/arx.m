...
% Example 1: [sysd, K] = mi.arx(u, y, np, nz, sampleTime);
% Example 2: [sysd, K] = mi.arx(u, y, np, nz, sampleTime, ktune);
% Example 3: [sysd, K] = mi.arx(u, y, np, nz, sampleTime, ktune, delay);
% Example 4: [sysd, K] = mi.arx(u, y, np, nz, sampleTime, ktune, delay, forgetting);
% A(q)*y(t) = B(q)*u(t) + e(t)
...
function [sysd, K] = arx(varargin)
  ...
  % Identify
  [sysd, K] = mi.rls(u, y, np, nz, 1, sampleTime, delay, forgetting);
