...
% Example 1: [sysd, K] = Mid.rls(u, y, np, nz, nze, sampleTime);
% Example 2: [sysd, K] = Mid.rls(u, y, np, nz, nze, sampleTime, delay);
% Example 2: [sysd, K] = Mid.rls(u, y, np, nz, nze, sampleTime, delay, forgetting);
