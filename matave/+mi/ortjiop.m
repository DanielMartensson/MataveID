...
% Example 1: [sysd, P, C] = mi.ortjiop(u, y, r, d, k, sampleTime);
% Example 2: [sysd, P, C] = mi.ortjiop(u, y, r, d, k, sampleTime, delay);
% Example 3: [sysd, P, C] = mi.ortjiop(u, y, r, d, k, sampleTime, delay, systemorder);
